...
bot.command('coinflip', (ctx) => {
    const coinflip = coinflip2[Math.floor(Math.random()*(coinflip2.length))];
    return ctx.reply(`${coinflip}`)
})
